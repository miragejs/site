...
Consistency is the name of the game when it comes to APIs. The more consistent your production API is, the easier it will be to implement it in Mirage. Use your Mirage server to communicate between your frontend and backend teams about inconsistencies in your API contract. The more conventional your API contract, the less code you'll need to write – not only in Mirage, but also in other parts of your JavaScript application code!
