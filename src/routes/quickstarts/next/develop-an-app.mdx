# Develop a Next App against a Shared Mirage Server
...
Open your Next app's initialization file (`pages/_app.js`), import your `makeServer` function, and call it in the development environment:
...
You now have a central place to define and update your Mirage server as you continue local development on your Next app.
