...
Vue CLI can be configured to not include Mirage in production builds of your application. This ensures that Mirage is only ever used in development and testing environments.
...
With this configuration Mirage will neither be included nor started in your production environment.
