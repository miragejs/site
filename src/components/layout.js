...
function MobileNavLink(props) {
  ...
  const baseClasses = `block py-2 font-medium`
  ...
  return <div className="border-b border-gray-800 py-1">{link}</div>
}
              ...
              <div className="flex items-center">
                ...
                <div className="ml-auto md:hidden">
                  <button
                    ...
                    className="flex px-4 py-3 items-center lg:hidden text-gray-500 focus:outline-none focus:text-gray-300"
                  >
                    {isShowingMobileNav ? (
                      <svg
