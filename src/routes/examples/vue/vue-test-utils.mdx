...
Let's use Mirage to test our data fetching App component. We're going to use the same server we defined in the [development](/examples/vue/development) example.
