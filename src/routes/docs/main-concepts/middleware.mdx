...
Middleware lets you write code which runs before and after route handlers, and middleware can be shared by many route handlers, too.

For example, you can write middleware to check requests on their way to the route handlers:
