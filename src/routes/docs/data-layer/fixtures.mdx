...
This data will be automatically loaded into Mirage's database as its starting data, unless you have a default scenario defined:

If you have a default scenario defined, Mirage assumes you want to use Factories to seed your data:
