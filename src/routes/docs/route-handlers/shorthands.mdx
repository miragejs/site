...
APIs have become more standardized, so Mirage has the concept of _Shorthands_ to make it easy for you to deal with common scenarios. Shorthands can replace many of your custom route handlers, dramatically simplifying your server definition.
