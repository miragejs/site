...
For example, you could seed it with some data in the default dev scenario:
...
Then you can access that data in your route handlers using the `schema` argument:
