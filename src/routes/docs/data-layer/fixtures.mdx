...
This data will be automatically loaded into Mirage's database as its starting data.

Typically fixtures are extracted to separate files. We can put this data into its own `fixtures/countries.js` file:
