...
That's because our GET handler is _static_ and returns the same three hard-coded todos every time. We've broken the _referential integrity_ of our application data, and it no longer behaves the same way our production app will.
