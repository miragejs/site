...
- Mirage is slightly easier to set up – just one import alongside any frontend code:
  ...
  MSW requires one additional step - you need to generate a file that in the public directory of your project, which you might also want to strip from production builds.
