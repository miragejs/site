...
In order to use this identify manager within your server:
...
import CustomIdentityManager from './CustomIdentityManager'
...
new Server({
  ...
  identityManagers: {
    ...
    application: CustomIdentityManager,

    // Per Model Identity Manager
    blogPost: CustomIdentityManager,
    author: DefaultIdentityManager,
  },
})
