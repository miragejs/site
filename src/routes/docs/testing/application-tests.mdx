...
One of the best uses cases for Mirage is that it enables JavaScript app developers to write high-level UI tests without them needing to configure or manipulate their production API servers.
